    ...
    var QuestionAndAnswerImpl = /** @class */ (function () {
        ...
        QuestionAndAnswerImpl.prototype.load = function () {
            ...
            for (var i=0; i<24; ++i) {
                ...
                this.intermLayerNames.push(`bert/encoder/layer_${i}/bottleneck/attention/FakeLayerNorm/add`);
                this.intermLayerNames.push(`bert/encoder/layer_${i}/bottleneck/value/FakeLayerNorm/add`);
                this.intermLayerNames.push(`bert/encoder/layer_${i}/bottleneck/input/FakeLayerNorm/add`);
            }
            // const bottleneckTestNames = ['bert/encoder/layer_1/bottleneck/attention/Shape_1',
            // 'bert/encoder/layer_1/bottleneck/attention/strided_slice_1',
            // 'bert/encoder/layer_1/bottleneck/attention/dense/mul',
            // 'bert/encoder/layer_1/bottleneck/attention/dense/Reshape_1/shape',
            // 'bert/encoder/layer_1/bottleneck/attention/dense/Reshape/shape',
            // 'bert/encoder/layer_1/bottleneck/attention/dense/Reshape',
            // 'bert/encoder/layer_1/bottleneck/attention/dense/MatMul',
            // 'bert/encoder/layer_1/bottleneck/value/dense/MatMul',
            // 'bert/encoder/layer_1/bottleneck/input/dense/MatMul',
            // 'bert/encoder/layer_1/bottleneck/attention/dense/add',
            // 'bert/encoder/layer_1/bottleneck/value/dense/add',
            // 'bert/encoder/layer_1/bottleneck/input/dense/add',
            // 'bert/encoder/layer_1/bottleneck/attention/dense/Reshape_1',
            // 'bert/encoder/layer_1/bottleneck/value/dense/Reshape_1',
            // 'bert/encoder/layer_1/bottleneck/input/dense/Reshape_1',
            // 'bert/encoder/layer_1/bottleneck/attention/FakeLayerNorm/mul',
            // 'bert/encoder/layer_1/bottleneck/value/FakeLayerNorm/mul',
            // 'bert/encoder/layer_1/bottleneck/input/FakeLayerNorm/mul',
            // 'bert/encoder/layer_1/bottleneck/attention/FakeLayerNorm/add',
            // 'bert/encoder/layer_1/bottleneck/value/FakeLayerNorm/add',
            // 'bert/encoder/layer_1/bottleneck/input/FakeLayerNorm/add',
            // 'bert/encoder/layer_1/output/bottleneck/Shape_1',
            // 'bert/encoder/layer_1/output/bottleneck/strided_slice_1',
            // 'bert/encoder/layer_1/output/bottleneck/dense/mul',
            // 'bert/encoder/layer_1/output/bottleneck/dense/Reshape_1/shape',
            // 'bert/encoder/layer_1/output/bottleneck/dense/Reshape/shape',
            // 'bert/encoder/layer_1/output/bottleneck/dense/Reshape',
            // 'bert/encoder/layer_1/output/bottleneck/dense/MatMul',
            // 'bert/encoder/layer_1/output/bottleneck/dense/add',
            // 'bert/encoder/layer_1/output/bottleneck/dense/Reshape_1',
            // 'bert/encoder/layer_1/output/bottleneck/add',
            // 'bert/encoder/layer_1/output/bottleneck/FakeLayerNorm/mul',
            // 'bert/encoder/layer_1/output/bottleneck/FakeLayerNorm/add'];
            // bottleneckTestNames.forEach(name => this.intermLayerNames.push(name));
        ...
        QuestionAndAnswerImpl.prototype.getBestAnswers = function (startLogits, endLogits, origTokens, tokenToOrigMap, context, docIndex) {
            ...
            var answers = [];
            var answersRawData = [];
            // get answer threshold from bertdemo answer threshold slider (#5)
            const rawScores = origResults.map(res => res.score);
            // const NO_ANSWER_THRESHOLD = rawScores.... (TODO)
            var NO_ANSWER_THRESHOLD = document.getElementById("answer-threshold-slider").value;
            console.log(`using threshold ${NO_ANSWER_THRESHOLD}`);
